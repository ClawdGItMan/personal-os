    ...
    >
      ...
      <div className="flex items-center gap-3 font-mono">
        ...
        <Link
          href="/settings"
          aria-label="Settings"
          className="w-7 h-7 rounded-os-pill bg-[color:var(--os-bg-3)] border border-[color:var(--os-line-2)] flex items-center justify-center text-[10px] text-[color:var(--os-fg-2)] hover:border-[color:var(--os-line-3)] focus-visible:outline-none focus-visible:border-[color:var(--os-accent)] transition-colors"
        >
          {operator.initials}
        </Link>
      </div>
